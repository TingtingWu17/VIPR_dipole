function [maskRec,gBlur,Nph,I_mod] = PR_coverslip_data(IS,IMG_T,q,std_stack,gpu_flag,vec_model_flag,cost_function_flag,plot_flag,Alg_flag,est_gBlur_flag,noisy_flag,vec_model_pol)
...
IS = pre_comp_opt(IS,vec_model_flag,vec_model_pol);
...
Cost_fun = @(phase_mask,q,data,std_stack_gpu,Nph_gpu,gBlur_gpu,Nph_opt_flag,cost_altr) CostPR_gpu(phase_mask,IS,q,data,(std_stack_gpu),Nph_gpu,cost_function_flag...
    ,gBlur_gpu ,k, opt_phase_mat ,g_bfp,vec_model_flag,int_cos,circ,circ_sc,Nph_opt_flag,cost_altr);
